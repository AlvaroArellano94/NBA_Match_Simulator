...
CREATE TABLE Player_Actions_Match (
    ...
    CONSTRAINT FK_Id_Match_Act FOREIGN KEY (Id_Match) REFERENCES Match(Id_Match),
    CONSTRAINT FK_Id_Player_Act FOREIGN KEY (Id_Player) REFERENCES Players(Id_Player),
