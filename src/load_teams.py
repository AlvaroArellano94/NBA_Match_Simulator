...
def players_team_loader():
    ...
    try:
        ...
        for player in cursor_Memphis_Players:
            ...
            player_i = Player(ID_player= player[0], name= player[1], position = player[2], fga_1_average= player[4], fga_2_average= player[5], fga_3_average= player[6], offense_participation=player[3], on_court = True)
