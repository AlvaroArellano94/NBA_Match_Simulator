...
def players_team_loader():
    ...
    player_6_abroad = Player(ID_player= 16, name= "J. McLaughlin", position = "1", fga_1_average= 0.79, fga_2_average= 0.33, fga_3_average= 0.30, offense_participation = 1, on_court = False)
    player_7_abroad = Player(ID_player= 17, name= "M. Beasley", position = "2",fga_1_average= 0.88, fga_2_average= 0.36, fga_3_average= 0.41, offense_participation = 2, on_court = False)
    player_8_abroad = Player(ID_player= 18, name= "J. McDaniels", position = "3",fga_1_average= 0.88, fga_2_average= 0.35, fga_3_average= 0.40, offense_participation = 2, on_court = False)
    player_9_abroad = Player(ID_player= 19, name= "T. Prince", position = "4",fga_1_average= 0.76, fga_2_average= 0.39, fga_3_average= 0.30, offense_participation = 1, on_court = False)
    player_10_abroad = Player(ID_player= 20, name= "N. Reid", position = "5",fga_1_average= 0.72, fga_2_average= 0.42, fga_3_average= 0.28, offense_participation = 1, on_court = False)
